...
def parse_args(args):
    ...
    parser.add_argument('--age-data-file',
        type=str,
        default="_output/age_data.pkl")
...
def main(args=sys.argv[1:]):
    ...
    age = pickle_from_file(args.age_data_file)

    fitted_models = [load_model(fitted_file) for fitted_file in args.fitted_files]
    plot_accept_prob_vs_age(fitted_models, test_dataset, age, args)
    plot_prediction_vs_age(fitted_models, test_dataset, age, args, "Predicted mortality")
