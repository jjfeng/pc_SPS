...
def main(args=sys.argv[1:]):
    ...
    for pi_alpha, inference_dicts in agg_dict.items():
        ...
        true_cov_given_accept_dict = indpt_aggregator.eval_cov_given_accept(test_data)["cov_given_accept"]
        ...
        # Evaluate conditional coverage (this is not local coverage, as the var name suggests)
        ...
        logging.info("indpt estimated agg cover given accept %f %s", indpt_agg_cov_given_accept_dict["mean"], indpt_ci)
