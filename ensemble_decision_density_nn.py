...
class EnsembleSimultaneousDensityDecisionNNs:
    ...
    def __init__(self,
            ...
            dec_embedder= None, # object like sklearn PCA
    ...
    def _init_nn(self, init_inner=False):
        self.nns = [SimultaneousDensityDecisionNNs(
            ...
            inflation_param=self.inflation_param,
            ...
            dec_embedder=self.dec_embedder,
    ...
    def set_params(self, **params):
        ...
        if "inflation_param" in params:
            self.inflation_param = params["inflation_param"]
        ...
        if "dec_embedder" in params:
            self.dec_embedder = params["dec_embedder"]
